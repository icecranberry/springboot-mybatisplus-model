...
public class MpGenerator {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        //输入你的工程位置绝对路径*
        gc.setOutputDir("F:/springboot-mybatisplus-model/src/main/java");
...
//        pc.setMapper("dao." + rb.getString("className"));
        ...
        focList.add(new FileOutConfig("/templates/mapper.xml.ftl") {
            ...
            public String outputFile(TableInfo tableInfo) {
                // 自定义输入文件名称
                return "F:/springboot-mybatisplus-model/src/main/resources/mapper/" + pc.getModuleName()
        ...
        //输入需要生成的表
        strategy.setInclude(new String[]{"test_model","test_user"});
